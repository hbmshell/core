...
function relpdf( lc_arq , ln_config )
   ...
   local cTemp := "F" + Dtos(Date()) + StrZero(Seconds(),6) + strzero( hb_RandomInt(1,1000) , 4 ) + ".lin"
...
Return HB_FNameName( lc_arq ) + '.pdf'
                                                                            /*
