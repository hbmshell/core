...
PROCEDURE Main()
   ...
   TestLine( "_SET_DIRSEPARATOR", 104 )
   TestLine('_SET_EOF',105)
   TestLine('_SET_HARDCOMMIT',106)
   TestLine('_SET_FORCEOPT',107)
   TestLine('_SET_DBFLOCKSCHEME',108)
   TestLine('_SET_DEFEXTENSIONS',109)
   TestLine('_SET_EOL',110)
   TestLine('_SET_TRIMFILENAME',111)
   TestLine('_SET_HBOUTLOG',112)
   TestLine('_SET_HBOUTLOGINFO',113)
   TestLine('_SET_CODEPAGE',114)
   TestLine('_SET_OSCODEPAGE',115)
   TestLine('_SET_TIMEFORMAT',116)
   TestLine('_SET_DBCODEPAGE',117)
