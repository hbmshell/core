//https://github.com/harbour/core/blob/master/contrib/hbmisc/tests/rtfclass.prg
/*
...
PROCEDURE Main()
   ...
   LOCAL cPrefixFile := "main"
   LOCAL cTemp := cPrefixFile + ".txt"
   ...
   oRtf := TRtf():new( hb_FNameExtSet( cPrefixFile , ".rtf" ) )
   oRtf:write( cTemp )
   oRtf:close()
   DELETE FILE ( cTemp )
